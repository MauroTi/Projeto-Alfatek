...
<body>
  ...
  $quantidade = isset($_POST['quantidade']) ? $_POST['quantidade'] : '';
	...
	$query = "SELECT * FROM pecas WHERE id LIKE '%$id%' AND nome_pendencias LIKE '%$nome_pendencias%' AND codigo_pendencias LIKE '%$codigo_pendencias%' AND quantidade_pendencias LIKE '%$quantidade_pendencias%' AND os_pendencias LIKE '%$os_pendencias%' AND nome LIKE '%$nome%' AND codigo LIKE '%$codigo%' AND quantidade LIKE '%$quantidade%'";
