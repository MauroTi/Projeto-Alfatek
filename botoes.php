<div class="centro" id="botoes">
					...
					<tr>
						...
						<td><button class="botoes_footer" style="border-radius: 10px;"><a href="cadastrar_estoque.php" style="color: #000;">Cadastrar Peças</a></button></td>
						...
						<td><button class="botoes_footer" style="border-radius: 10px;"><a href="lista_estoque.php" style="color: #000;">Lista de Compras</a></button></td>
